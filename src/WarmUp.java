...
public static void main(String [] args){
     ...
     */
        ...
        // HINT: You can fix the unexpected behavior by altering or adding a single line
            ...
            System.out.print("Welcome to 'PRINT THE VEGETABLE COUNT' app!\n");
...
// next line takes the new line character as the input that is why we can use next
// but that causes a problem in not taking two strings , that is why introduce a nextLine in between